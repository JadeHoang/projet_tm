...
find_position(1,"paul atreides","lady jessica")
```
...
scores(find_position(1,"paul atreides","paul atreides")$s, 
       find_position(1,"paul atreides","paul atreides")$t)

scores(find_position(1,"paul atreides","lady jessica")$s, 
       find_position(1,"paul atreides","lady jessica")$t)

scores(find_position(1,"paul atreides","duke leto atreides")$s, 
       find_position(1,"paul atreides","duke leto atreides")$t)

scores(find_position(1,"lady jessica","paul atreides")$s, 
       find_position(1,"lady jessica","paul atreides")$t)

scores(find_position(1,"duke leto atreides","paul atreides")$s, 
       find_position(1,"duke leto atreides","paul atreides")$t)
```
...
cooccurences <- lapply(seq_len(ncol(mult)), function(i) {
  ...
  # mat <- as.matrix(mult[, seq_len(2)]) #column of chap 1:i
  mat <- as.matrix(mult[, i])
  mat <- as.matrix(mat[rowSums(mat) > 0, ]) #character with value 1
  co <- mat %*% t(mat) %>% 
